...
struct Event: Identifiable, Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case id, title, description, date, color, amount, category, isExpense, shareGroupSize, splitMethod, groupId, author, updatedAt, syncStatus
    }
    ...
    init(
        ...
        isExpense: Bool,
        shareGroupSize: Int = 1,
        splitMethod: SplitMethod = .personal,
        groupId: String? = nil,
        author: String? = nil,
        updatedAt: Date = Date(),
        ...
        self.shareGroupSize = shareGroupSize
    ...
    init(from decoder: Decoder) throws {
        ...
        color = try container.decode(EventColor.self, forKey: .color)
        ...
        shareGroupSize = try container.decodeIfPresent(Int.self, forKey: .shareGroupSize) ?? 1
        splitMethod = try container.decodeIfPresent(SplitMethod.self, forKey: .splitMethod) ?? .personal
